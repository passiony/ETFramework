...
namespace ETEditor
{
    ...
    public class ManifestInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Space(2);
            if (GUILayout.Button("Load Version", EditorStyles.miniButton, GUILayout.MaxWidth(100)))
            {
                StartUpVersionHelper.LoadVersionFile(null);
            }
            GUILayout.Space(10);
            if (GUILayout.Button("Save Version", EditorStyles.miniButton, GUILayout.MaxWidth(100)))
            {
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("appVersion"), true);
            EditorGUILayout.PropertyField(serializedObject.FindProperty("resVersion"), true);
            EditorGUILayout.PropertyField(serializedObject.FindProperty("serverMode"),true);
            EditorGUILayout.PropertyField(serializedObject.FindProperty("channelType"),true);
