...
namespace AssetBundles
{
    ...
    public class AssetBundleDispatcherInspector : Editor
    {
        ...
        void Initialize()
        {
            ...
            databaseAssetPath = AssetBundleUtility.AssetPathToDatabasePath(targetAssetPath);
        ...
        void DrawCreateAssetBundleDispatcher()
        {
            if (GUILayout.Button("Create AssetBundle Dispatcher"))
            {
                ...
                FileUtility.CheckDirAndCreateWhenNeeded(dir);
        ...
        void Remove()
        {
            FileUtility.SafeDeleteFile(databaseAssetPath);
            AssetDatabase.Refresh();
        ...
        {
            base.OnInspectorGUI();
            if (!AssetBundleUtility.CheckMaybeAssetBundleAsset(targetAssetPath))
            {
                return;
            }
            GUI.enabled = true;
