...
namespace XAsset
{
    public class FileUtility
    {
        ...
        public static void DeleteDirectoryExcept(string dirPath,string exceptPath)
        {
            string[] files = Directory.GetFiles(dirPath);
            string[] dirs = Directory.GetDirectories(dirPath);
        ...
        public static bool SafeClearDirExcept(string folderPath,string exceptPath)
        {
            try
            {
                if (string.IsNullOrEmpty(folderPath))
                ...
                if (Directory.Exists(folderPath))
                {
                    DeleteDirectoryExcept(folderPath, exceptPath);
                }
                Directory.CreateDirectory(folderPath);
                return true;
            }
