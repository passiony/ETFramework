...
namespace ETModel
{
    public class WChannel: AChannel
    {
        ...
        public WChannel(HttpListenerWebSocketContext webSocketContext, AService service): base(service, AChannelType.Accept)
        {
        ...
        public WChannel(WebSocket webSocket, AService service): base(service, AChannelType.Connect)
        {
