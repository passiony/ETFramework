...
namespace ETModel
{
	...
	public partial class Entity : Object, IDisposable
	{
        ...
        public Entity AddComponent<P1>(Type type, P1 p1)
        {
            Entity component = CreateWithComponentParent(type, p1);
        ...
        public Entity AddComponent<P1, P2>(Type type, P1 p1, P2 p2)
        {
            Entity component = CreateWithComponentParent(type, p1, p2);
        ...
        public Entity AddComponent<P1, P2, P3>(Type type, P1 p1, P2 p2, P3 p3)
        {
            Entity component = CreateWithComponentParent(type, p1, p2, p3);
